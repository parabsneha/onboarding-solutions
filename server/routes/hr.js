...
router.post('/editTask',passport.authenticate('jwt', { session: false}),authEmployee(['employee']), hrController.getEditTaskForUser);
// router.post('/editTask',passport.authenticate('jwt', { session: false}),authEmployee(['employee']), hrController.postEditTaskForUser);
router.post('/viewUserTask',passport.authenticate('jwt', { session: false}),authEmployee(['employee']), hrController.viewUserTask); 
